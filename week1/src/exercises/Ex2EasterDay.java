...
public class Ex2EasterDay {
    ...
    void program() {
        ...
        if (date<32){
            System.out.println("Easter for the year "+year+" is on the "+date+" of march.");
        }
        if (date==26){
            System.out.println("Easter for the year "+year+" is on the 19 of april.");
        }
        if (date==25 && a==16 && d==28){
            System.out.println("Easter for the year "+year+" is on the 18 of april.");
        }
        if (date>=32){
            date = d + e - 9;
            System.out.println("Easter for the year "+year+" is on the "+date+" of april.");
        }
    }
}
